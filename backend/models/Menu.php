...
class Menu extends \yii\db\ActiveRecord
{
    ...
    public function getTypes()
    {
        ...
        return [
            1 => Yii::t('app', 'MENU_TYPE_APPLICATION'),
            2 => Yii::t('app', 'MENU_TYPE_CATEGORY'),
            3 => Yii::t('app', 'MENU_TYPE_ITEM'),
            4 => Yii::t('app', 'MENU_TYPE_JSON'),
            5 => Yii::t('app', 'MENU_TYPE_LINK'),
            6 => Yii::t('app', 'MENU_TYPE_WIDGET'),
        ];
